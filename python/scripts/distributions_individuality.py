...
dbins = 10;  # bins for histograms
sbins = 75;  # time windows in each stage
tbins = nstages * sbins; # total number of time windows

fig_dir = '/data/Science/Projects/CElegansBehaviour/Analysis/DwellingRoaming/Figures/2016_10_21'
