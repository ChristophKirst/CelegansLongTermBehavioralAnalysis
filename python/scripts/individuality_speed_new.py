...
#%%
fig.savefig(os.path.join(fig_dir, '%s_distributions_roaming_speed_sbins=%d.pdf' % (strains_label, sbins)))
...
for nst, strain_ref in enumerate([strains[0]]):
  ...
  fig.savefig(os.path.join(fig_dir, '%s_cv_JS_time_signed_ref=%s_lines_sbins=%d.pdf' % (strains_label, strain_ref, sbins)));
  ...
  fig.savefig(os.path.join(fig_dir, '%s_cv_JS_time_signed_ref=%s_matrix_sbins=%d.pdf' % (strains_label, strain_ref, sbins)));
  
  np.savetxt(os.path.join(fig_dir, '%s_cv_JS_time_signed_ref=%s_matrix_sbins=%d.txt' % (strains_label, strain_ref, sbins)), dd)
  ...
  fig.savefig(os.path.join(fig_dir, '%s_cv_JS_time_signed_significance_ref=%s_matrix_sbins=%d.pdf' % (strains_label, strain_ref, sbins)));
...
np.savetxt(os.path.join(fig_dir, 'JS_roaming_speed_sbins=%d.txt' % sbins), dd)
np.savetxt(os.path.join(fig_dir, 'JS_roaming_speed_pvals_sbins=%d.txt' % sbins), pvals)
